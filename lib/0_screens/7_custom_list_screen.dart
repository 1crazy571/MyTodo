...
class _CustomScreenState extends State<CustomScreen> {
  ...
  void initState() {
    ...
    userDatabaseProvider.initialize().then((value) {
      context.read<ToDoCubit>().fetchDataFromDatabase(widget.customTableName);
    });
  }
            ...
            child: Stack(
              children: [
                ...
                if (bottomAddWidget)
                  Positioned(
                    bottom: 0,
                    child: ToDoSubmit.fromCustom(
                      tableName: widget.customTableName,
